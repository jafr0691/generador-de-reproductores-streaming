(function ($) {
    "use strict";
	$(".dos").append('<div class="player-wpr"><a id="botonMio" style="cursor:pointer"><div id="pantalla" class="pantalla"><p id="latido" class="latido">Haga click para comenzar a reproducir</p></div></a><div class="bg-wpr"><div class="blur"></div><div class="player-ctr"><a class="abuy" id="cancion" target="_blank" href=""><div class="icons fa fa-whatsapp" id="icon-download"></div></a><div class="icons fa fa-times" id="icon-popup" target="_blank" href=""></div><div class="listeners fa" title="Oyentes"></div><div class="album-cover-wpr"><div class="social-share-wpr animated"> Compartir emisora en<br><br> <a href="" target="_blank" class="social-link social-link-facebook fa animated" id="aface"></a> <a href="" target="_blank" class="social-link social-link-whatsapp fa animated" id="awhatsapp"></a> <a href="" target="_blank" class="social-link social-link-twitter fa animated" id="atwitter"></a></div><div class="album-cover animated"></div></div><div class="track-info-wpr"><div class="track-info-ctr"><span id="info-text" class="nd" style="font-size: 18px;"> </span><div class="marquee"> <span id="titulo2" class="artist-name animated">En Vivo</span><span> - </span><span class="songtitle animated" id="titulo1">Buena Música</span></div></div></div><div class="ppBtn play-btn"></div><div class="servertitle"></div></div><div class="icons-left-wpr"><div class="icons-left icons-history fa"></div></div><div class="icons-right-wpr"><div class="icons-right icons-volume fa"></div><div class="icons-right icons-volumeM fa"></div></div> <input class="volume-slider" type="range" min="0" max="100" step="0.10" value="" autocomplete="off"><div class="history-wpr nodisplay"><div class="history-title">Últimas canciones </div></div></div></div>');
