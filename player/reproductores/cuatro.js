(function(d, D) {
    ...
    d.fn.cuatro = function(m) {
        ...
        w ? this.each(function() {
            var G = d(this).data("cuatro"),
                F = G && d.isFunction(G[m]) ? G[m].apply(G, t) : G;
            if (F !== G && F !== D) return K = F, !1
        }) : this.each(function() {
            d(this).data("cuatro", new d.cuatro(this,
                m))
        });
        return K
    };
    d.cuatro = function(m, w) {
        function t(b, a) {
        ...
        */
        ...
        function nb(b) {
            ...
            d("#" + c + "textradioname").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "textradioname").html(d("." + c + "textradionamespan")).cuatrodisableSelection();
            m = document.createElement("span");
            ...
            d("#" + c + "texttitle").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "texttitle").html(d("." + c + "texttitlespan")).cuatrodisableSelection();
            m = document.createElement("div");
            ...
            d("#" +
                ...
                "font-family": "Roboto",
                color: x
            }).html("100").cuatrodisableSelection();
            xb(a);
            yb(a);
        ...
        function Wa(b) {
            if ("true" == zb) {
                var a = "";
                "small" == ja && (a = "small");
                b && d("#" + c + a + "texttitle").hasClass(c + "Marquee") && (d("#" + c + a + "texttitle").removeClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").data("cuatroMarquee").pause());
                d("#" + c + a + "textradioname").width() > d("." +
                    c + a + "textradionamespan").first().width() ? d("#" + c + a + "textradioname").hasClass(c + "Marquee") && (d("#" + c + a + "textradioname").removeClass(c + "Marquee"), d("#" + c + a + "textradioname").html(d("." + c + a + "textradionamespan").first()), d("#" + c + a + "textradioname").data("cuatroMarquee").pause()) : d("#" + c + a + "textradioname").hasClass(c + "Marquee") || (d("#" + c + a + "textradioname").addClass(c + "Marquee"), d("#" + c + a + "textradioname").html(d("." + c + a + "textradionamespan").first()), d("#" + c + a + "textradioname").cuatroMarquee());
                d("#" +
                    c + a + "texttitle").width() > d("." + c + a + "texttitlespan").first().width() ? d("#" + c + a + "texttitle").hasClass(c + "Marquee") && (d("#" + c + a + "texttitle").removeClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").data("cuatroMarquee").pause()) : d("#" + c + a + "texttitle").hasClass(c + "Marquee") || (d("#" + c + a + "texttitle").addClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").cuatroMarquee())
            }
        }
        ...
        function yb(b) {
            ...
            d("#" + c + "buttonpause").css({
                ...
                d(this).css("fill", x)
            }).fadeOut(0).cuatrodisableSelection();
            b = document.createElement("div");
        ...
        function wb(b) {
            ...
            h = document.createElement("div");
            h.id = c + "cuatrocoverwrapper1";
            a.appendChild(h);
            d("#" + c + "cuatrocoverwrapper1").css({
                position: "absolute",
                left: "0px",
                top: "0px",
                height: "100%",
        ...
        function ob(b) {
            ...
            d("#" + c + "smalltextradioname").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "smalltextradioname").html(d("." + c + "smalltextradionamespan")).cuatrodisableSelection();
            b = document.createElement("span");
            ...
            d("#" + c + "smalltexttitle").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "smalltexttitle").html(d("." + c + "smalltexttitlespan")).cuatrodisableSelection();
            b = document.createElement("div");
        ...
        function Ka() {
            ...
            try {
                d(".lunaaudioplayer").each(function() {
                    d(this).attr("id") != c && d(this).data("cuatro").pause()
                })
            } catch (b) {
                E(b)
            }
        ...
        if (arguments.length) {
            ...
            var Kb = this;
            this.element.bind("remove.cuatro", function() {
                Kb.destroy()
            })
        }
        ...
        d(document).ready(function() {
            var b = document.getElementsByTagName("script"),
                a, h;
            for (a = 0; h = b[a]; a++)
                if (h = h.src, 0 <= h.indexOf("cuatro.min.js")) var f = h.substring(0, h.indexOf("cuatro.min.js"));
            Y = f;
            E("SCRIPT FOLDER: " + Y);
            c = Jb;
            C = d("#" + c).width();
        ...
        jQuery.fn.extend({
            cuatrodisableSelection: function() {
                this.each(function() {
...
(function(d, D) {
    ...
    "undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (exports = module.exports =
        F), exports.cuatroParser = F) : "function" === typeof define && define.amd ? define(function() {
        return F
    }) : d && (d.cuatroParser = F);
...
(function(d, D) {
    ...
    d.fn.cuatroMarquee = function(m) {
        ...
        if (w && "_" === m.charAt(0)) return K;
        w ? this.each(function() {
            var G = d(this).data("cuatroMarquee"),
                F = G && d.isFunction(G[m]) ? G[m].apply(G, t) : G;
            if (F !== G && F !== D) return K = F, !1
        }) : this.each(function() {
            d(this).data("cuatroMarquee",
                new d.cuatroMarquee(this, m))
        });
        return K
    };
    d.cuatroMarquee = function(m, w) {
        function t() {
            var p = N ? -1 : 1,
                y = N ? -1 * G : 0;
