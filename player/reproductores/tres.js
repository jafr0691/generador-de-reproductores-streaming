(function ($) {
     "use strict";
     $("div.tres").append(
         '<div class="blur"></div><div class="mainsctn"><a id="botonMio" style="cursor:pointer"><div id="pantalla" class="pantalla"><p id="latido" class="latido">Haga click para comenzar a reproducir</p></div></a><div class="frnt"><div class="track-info animated"> <div class="tocando"> <div class="track-info-wpr"> <div class="track-info-ctr"><div class="marquee"> <span id="titulo2" class="ttl">Cargando Radio...</span> - <span id="titulo1" class="arst"></span> </div></div></div></div></div><div class="atwrk"></div><div class="plbtn plystp icon-play2 fal"></div><div class="itns icon-appless fab fa-apple"><a href="" target="_blank" title="iTunes"></a></div> <div class="vlm icon-volume-100 fal"><div class="pnlVol" style="display:none"><input class="volsl" type="range" min="0" max="100" value="100"></div></div><div class="shr icon-shr2 fal fa-share-alt"><div class="pnl" style="display:none"><div class="fb icon-fb fab fa-facebook-f"><a href="" target="_blank" title="Share on Facebook"></a></div><div class="tw icon-tw2 fab fa-twitter"><a href="" target="_blank" title="Share on Twitter"></a></div><div class="emil icon-envelop fal fa-envelop"></div></div></div><div class="timg">00:00</div><div class="mnu icon-menu1 fal fa-menu"></div></div><div class="bck fal fa-times-circle" style="display:none"><div class="rinfo" fal fa-info><div class="radnme"><span class="icon-radio-tw2 fal fa-microphone"></span><a target="_blank" href="" title="Visit Website">&nbsp;</a></div></div><div class="rhis"><ul></ul></div><div class="mnu"></div></div></div>').attr("data-tag");
     ...
     $.fn.tres = function (options) {
         var settings = $.extend({
             ...
             default_image: "https://cdn.mexiserver.com/imagenes/caratula-sonido.gif",
             blurriness: "",
             autoplay: true,
             src: "",
             itunes: true,
         ...
         thisObj.each(function () {
             ...
             if (settings.type == "shoutcast") {
				...
				if(settings.enable_cors == true) {
                 ...
                 updateIC(dataURL);
             } else if (settings.type.toLowerCase() == "apagado") {
         ...
         function playManagement() {
             if (audio.paused) {
                 ...
                 $(".tres", thisObj).removeClass("nakhon ");
             } else {
                 audio.pause();

                 $(thisObj).addClass("nakhon");
                 $(".tres", thisObj).removeClass("bekhon");
             }
